      ...
      <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex-1 max-w-lg mt-8">
            ...
            <div className="space-y-4 text-foreground">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm">Хорошо спроектированная база данных — фундамент любого надёжного приложения.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Лекция охватывает 4 части: от теории СУБД до нормализации и денормализации на практике.</p>
              </div>
            </div>
          </div>
        ...
        <div id="contact" className="w-full px-6 py-16 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-0 border-t border-border mt-16">
          <div className="flex flex-col md:flex-row gap-2 text-center md:text-left">
            <h2 className="text-foreground font-mono text-xl font-bold">Записаться на лекцию!</h2>
            <p className="text-foreground font-mono font-normal text-base">90–120 минут, которые изменят ваш подход к данным</p>
          </div>
        ...
        <div className="w-full px-6 py-4 border-t border-border flex md:flex-row items-center justify-between gap-2 flex-row">
          <p className="text-muted-foreground text-sm font-mono">2026 Лекция по БД</p>
